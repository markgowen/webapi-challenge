...
- [x] Mention two parts of Express that you learned about this week.
        ...
        Routing - allows us to build endpoints that we can branch off of
        Middleware -  functions that can execute in an order we define. Works as validation

- [x] Describe Middleware?

        Middleware allows us to create functions that can validate other functions

- [x] Describe a Resource?

        data stored in our api that the client can access
...
- [x] How can we partition our application into sub-applications?
        ...
        routers allow us to create component like functions to keep code organized
